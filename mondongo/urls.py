...
urlpatterns = patterns('',
                       url(r'^$', 'mondongo.views.view'),
                       #url(r'^view/$', 'mondongo.views.view'),
                       url(r'^create_form/$', 'mondongo.views.create_form'),
                       url(r'^create/$', 'mondongo.views.create'),
                       url(r'^destroy/$', 'mondongo.views.destroy'),
                      )
