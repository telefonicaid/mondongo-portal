...
# Django settings for MondongoServer project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'D:\python-workspace\_sqlite\mondongo.db',  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'y$@%^!evwo!6e8#l3dmgw^rx!x*gp%!in010pra^0ikbl08xhi'
